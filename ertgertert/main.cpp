...
int main()
{
    ...
    btn[0] = {50, 30, "Персонажи", "Персонаж"};
    btn[1] = {200,30, "Враги", "Враг"};
    btn[2] = {350,30, "Растительность", "Растительность"};
    btn[3] = {500,30, "Зелья", "Зелья"};
    btn[4] = {650,30, "Питомец", "Питомец"};
    btn[5] = {800,30, "Еда", "Еда"};
    btn[6] = {950,30, "Разное", "Разное"};
    ...
    count_pic = readFromDir("Pictures/Враг/", menuPic, count_pic);
    count_pic = readFromDir("Pictures/Растительность/", menuPic, count_pic);
    count_pic = readFromDir("Pictures/Зелья/", menuPic, count_pic);
    count_pic = readFromDir("Pictures/Питомец/", menuPic, count_pic);
    count_pic = readFromDir("Pictures/Еда/", menuPic, count_pic);
    count_pic = readFromDir("Pictures/Разное/", menuPic, count_pic);
    ...
    while(!btn[btn_exit].click())
    {
        ...
        else if(page == page_help)
        {
            ...
            txDrawText(0, 200, 1200, 600,
                        "Программа 'не Гардероб'.\n\n"
                        "Выбирай персонажей, врагов, декорации.\n"
